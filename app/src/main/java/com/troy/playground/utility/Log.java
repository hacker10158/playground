 ...
 * for instance : {@code Log.i("hello"); // in class LaunchActivity, as default output "tmms-LaunchActivity hello"}
...
public class Log
{
    ...
    private static String sAppName = "Soocii";
    ...
    private static String[] getCallerInfo2(StackTraceElement[] st)
    {
        boolean findSelf = false;
        String[] info = new String[]
                { "Unknown", "Unknown" };
